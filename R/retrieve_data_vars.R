...
#' using [retrieve_data()]. Once set, the API key will be saved across R 
...
retrieve_data_vars <- function() {
  ...
  vars_df <- data.frame(
    ...
    source = c(rep("Census Bureau API - American Community Survey 5-year estimates (note: these estimates should only be compared with each other across non-overlapping 5-year periods; see https://www.census.gov/programs-surveys/acs/guidance/comparing-acs-data.html for more guidance on data use)", 15), "U.S. Bureau of Economic Analysis API", rep("U.S. Environmental Protection Agency (see https://aqs.epa.gov/aqsweb/airdata/download_files.html for more information on data files)", 2), rep("U.S. Federal Bureau of Investigation - Crime in the United States estimations (be careful in comparing estimates across years; see https://ucr.fbi.gov/ucr-statistics-their-proper-use for additional guidance on data use)", 2), "U.S. Federal Bureau of Investigation - Crime in the United States estimations (be careful in comparing estimates across years; see https://ucr.fbi.gov/ucr-statistics-their-proper-use for additional guidance on data use; note that the definition of rape was changed between 2012 and 2013, see https://ucr.fbi.gov/crime-in-the-u.s/2013/crime-in-the-u.s.-2013/rape-addendum/rape_addendum_final for more details)", rep("U.S. Federal Bureau of Investigation - Crime in the United States estimations (be careful in comparing estimates across years; see https://ucr.fbi.gov/ucr-statistics-their-proper-use for additional guidance on data use)", 6)),
