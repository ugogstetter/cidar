...
retrieve_point_polygon_features <- function() {
  features_df <- data.frame(
    ...
    geogs_available = c(rep("state, county, cbsa, place", 2), rep("state, county, cbsa, place, zip code", 2), "state, county, cbsa, place, zip code", "state, county, cbsa, place")
  ) |>
